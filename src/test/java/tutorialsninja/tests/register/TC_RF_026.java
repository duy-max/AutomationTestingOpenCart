...
public class TC_RF_026 {
    ...
    public void verifyUIOfRegisterAccountPage() throws IOException {
        ...
        Assert.assertTrue(CommonUtils.compareImages(System.getProperty("user.dir")+"\\Screenshots\\actualRegisterPageUI.png", System.getProperty("user.dir")+"\\Screenshots\\expectedRegisterPageUI.png"));
